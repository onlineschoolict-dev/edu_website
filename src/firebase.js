...
const firebaseConfig = {
  apiKey: import.meta.env.VITE_FIREBASE_API_KEY || 'AIzaSyDbcEQJ8RyT7giD2Hq9wR-eUi5BSOcHfBc',
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || 'online-school-fe686.firebaseapp.com',
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || 'online-school-fe686',
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || 'online-school-fe686.firebasestorage.app',
  messagingSenderId: import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID || '92085987254',
  appId: import.meta.env.VITE_FIREBASE_APP_ID || '1:92085987254:web:a7bf156b69b1a76b44c317',
  measurementId: import.meta.env.VITE_FIREBASE_MEASUREMENT_ID || 'G-M3TNFNW8K7'
}
